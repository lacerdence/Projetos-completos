inherited Frm_venda: TFrm_venda
  ...
  object Q_cliente: TFDQuery
    ...
    SQL.Strings = (
      'select id_cliente,'
      'nome from cliente order by id_cliente')
    Left = 636
    Top = 207
  ...
  object Q_forma_pgto: TFDQuery
    ...
    SQL.Strings = (
      ...
      'descricao from forma_pgto order by id_forma_pgto')
    Left = 652
    Top = 271
  end
  ...
  object Q_conta_receber: TFDQuery
    ...
    object Q_conta_receberTOTAL_RECEBER: TFMTBCDField
      FieldName = 'TOTAL_RECEBER'
